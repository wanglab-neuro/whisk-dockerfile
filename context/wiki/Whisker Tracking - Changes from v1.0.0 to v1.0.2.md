...
[Janelia Research Campus Wiki](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/)
=========================================================================================================
...
*   [Help](# "Help")
    ...
    *   [Online Help](https://web.archive.org/web/20211020154224/https://docs.atlassian.com/confluence/docs-613/ "Visit the Confluence documentation home")
    *   [Keyboard Shortcuts](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki "View available keyboard shortcuts (?)")
    *   [Feed Builder](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/dashboard/configurerssfeed.action "Create your custom RSS feed.")
    *   [What’s new](https://web.archive.org/web/20211020154224/https://confluence.atlassian.com/display/DOC/Confluence+6.13+Release+Notes)
    *   [Available Gadgets](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki "Browse gadgets provided by Confluence")
    *   [About Confluence](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/aboutconfluencepage.action "Get more information about Confluence")
    

*   [Log in](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/login.action?os_destination=%2Fdisplay%2FMyersLab%2FChanges%2Bfrom%2Bv1.0.0%2Bto%2Bv1.0.2)

  

[![Myers Lab](Changes%20from%20v1.0.0%20to%20v1.0.2%20-%20Myers%20Lab%20-%20Janelia%20Research%20Campus%20Wiki_files/default-space-logo.svg)](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Home?src=sidebar "Myers Lab")

[Myers Lab](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Home?src=sidebar "Myers Lab")

*   [Pages](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/collector/pages.action?key=MyersLab&src=sidebar-pages)
*   [Blog](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/pages/viewrecentblogposts.action?key=MyersLab&src=sidebar-blogs)

##### Child pages

*   [Whisker Tracking Downloads](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Whisker+Tracking+Downloads?src=contextnavchildmode "Whisker Tracking Downloads")

*   Changes from v1.0.0 to v1.0.2

[](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/collector/pages.action?key=MyersLab&src=sidebar " (g , s)")<h2>Space Details</h2><div class="personal-space-logo-hint">Your profile picture is used as the logo for your personal space. <a href="/wiki/users/profile/editmyprofilepicture.action" target="\_blank">Change your profile picture</a>.</div>

Browse pages

ConfigureSpace tools

*   [Overview](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/spaces/viewspacesummary.action?key=MyersLab&src=spacetools)
*   [Content Tools](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/pages/reorderpages.action?key=MyersLab&src=spacetools)

*   [Browse pages](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/pages/reorderpages.action?key=MyersLab&src=spacetools)

*   [](#)
    
    *   [Attachments (0)](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/pages/viewpageattachments.action?pageId=1182889 "View Attachments (t)")
    *   [Page History](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/pages/viewpreviousversions.action?pageId=1182889)
    
    *   [Page Information](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/pages/viewinfo.action?pageId=1182889)
    *   [Resolved comments (0)](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki)
    *   [View in Hierarchy](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/pages/reorderpages.action?key=MyersLab&openId=1182889#selectedPageInHierarchy)
    *   [View Source](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/plugins/viewsource/viewpagesrc.action?pageId=1182889)
    *   [Export to PDF](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/spaces/flyingpdf/pdfpageexport.action?pageId=1182889)
    *   [Export to Word](https://web.archive.org/web/20211020154224/https://wiki.janelia.org/wiki/exportword?pageId=1182889)
    

1.  [Dashboard](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/collector/pages.action?key=MyersLab&src=breadcrumbs-collector)
2.  **…**
3.  [Home](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Home?src=breadcrumbs-expanded)
4.  [Whisker Tracking](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Whisker+Tracking?src=breadcrumbs-expanded)
5.  [Whisker Tracking Downloads](https://web.archive.org/web/20211020154224mp_/https://wiki.janelia.org/wiki/display/MyersLab/Whisker+Tracking+Downloads?src=breadcrumbs-parent)
