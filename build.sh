...
## Versions:
# whisk-ww:nb-0.3.0 - WhiskiWrap 1.2.6, whisk-janelia 1.2.5. PyPI-based (Dockerfile-ww): pip install only, no source build / conda / whisk-base. Ships the learned coverage model (--learned); whisk auto-downloads+preloads its FFmpeg libs on import.
