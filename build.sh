...
docker build -t wanglabneuro/whisk-base:latest -t wanglabneuro/whisk-base:0.2.1 -f Dockerfile-whisk-mex context
docker build -t wanglabneuro/whisk-ww:latest -t wanglabneuro/whisk-ww:nb-0.2.5 -f Dockerfile-ww-nb context
